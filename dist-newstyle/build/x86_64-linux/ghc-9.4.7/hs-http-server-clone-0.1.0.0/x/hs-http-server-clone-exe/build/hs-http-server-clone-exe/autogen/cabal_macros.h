...
/* package hs-http-server-clone-0.1.0.0 */
#ifndef VERSION_hs_http_server_clone
#define VERSION_hs_http_server_clone "0.1.0.0"
#endif /* VERSION_hs_http_server_clone */
#ifndef MIN_VERSION_hs_http_server_clone
#define MIN_VERSION_hs_http_server_clone(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hs_http_server_clone */
...
#define CURRENT_COMPONENT_ID "hs-http-server-clone-0.1.0.0-inplace-hs-http-server-clone-exe"
